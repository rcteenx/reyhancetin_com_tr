...
export default function AdWorkshop() {
  return (
    <div className="border border-primary/80 rounded-xl py-4 px-8 text-center">
      <h4 className="">
        <a
      ...
      <ul className="flex items-center justify-center gap-4">
        <li className="px-4 py-2 gradientAccent gradientTransition text-white hover:bg-primary/80 rounded-xl cursor-pointer">
